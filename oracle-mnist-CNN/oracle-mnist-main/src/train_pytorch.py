...
class Net4(nn.Module):
    def __init__(self):
        ...
        self.conv1 = torch.nn.Sequential(
            ...
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(2, 2)    # 16*14*14
        )
        self.conv2 = torch.nn.Sequential(
            torch.nn.Conv2d(16, 32, 3, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(2, 2)  # 32*7*7
        )
        self.conv3 = torch.nn.Sequential(
            torch.nn.Conv2d(32, 64, 3, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(1, 1)  # 64*7*7
        )

        self.fc1 = torch.nn.Sequential(
            torch.nn.Linear(64 * 7 * 7, 32),
            torch.nn.ReLU()
        )
...
def main():
    ...
    parser.add_argument('--net', type=str, default='Net1', choices=["Net1", "Net2", "Net3", "Net4", "Net5", "Net6"], help='type of network')
